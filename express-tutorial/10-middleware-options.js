// Notes: 
// Middleware Function Options - create our own / express built-in / third party
...
// 1. Middleware use method vs route 
...
// Read How To Use Morgan Middleware: https://www.npmjs.com/package/morgan
app.use(morgan('tiny'));
...
app.get(
    '/api/items',
    // logger,
    // [logger, authorize], // Add Multiple Middleware Functions
    (req, res) => {
        console.log(req.user);
